...
line_odd = [[18.5,-375],[19.5,-280],[20.5,-230],[21.5,-180],[22.5,-130],[23.5,100],[24.5,110],[25.5,130],[26.5,160]] 


total_points_allowed = sum(team_points_allowed.values())
mean_points_allowed = total_points_allowed / len(team_points_allowed)
adjusted_matchup = 22.19/ mean_points_allowed
simulated_points = np.where(simulated_points >= 0, simulated_points ** adjusted_matchup, 0)
...
plt.title('Cade Cunninham Season Distribution of Predicted Points')
