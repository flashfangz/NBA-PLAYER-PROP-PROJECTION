...
line_odd = [[17.5,-350],[18.5,-280],[19.5,-230],[20.5,-170],[21.5,-120],[22.5,105],[23.5,115],[24.5,135]] 

total_points_allowed = sum(team_points_allowed.values())
mean_points_allowed = total_points_allowed / len(team_points_allowed)
adjusted_matchup = 23.62/ mean_points_allowed
...
for line, odds in line_odd:
    ...
    print(f"Line: {line}, Odds: {odds}, Projected Chance: {(edge + (implied_prob*100)):.2f}, Edge: {edge:.2f}%")
...
plt.title('Wemby Season Distribution of Predicted Points')
