...
fga = fga[1:last]
fgm = fgm[1:last]
off_rat = off_rat[1:last]
min = min[1:last]
opponent_teams = opponent_teams[1:last]
...
plt.title('Shai Season Distribution of Predicted Points')
