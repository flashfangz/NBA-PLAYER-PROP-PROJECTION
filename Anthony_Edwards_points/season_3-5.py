...
line_odd = [[26.5,-300],[27.5,-250],[28.5,-210],[29.5,-155],[30.5,-125,],[31.5,-105,],[32.5,115,],[33.5,130,],[34.5,150]] 

total_points_allowed = sum(team_points_allowed.values())
mean_points_allowed = total_points_allowed / len(team_points_allowed)
adjusted_matchup = 19.64 / mean_points_allowed
...
plt.title('Anthony edwards Season Distribution of Predicted Points')
