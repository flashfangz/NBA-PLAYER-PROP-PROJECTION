...
line_odd = [[16.5,-375],[17.5,-280],[18.5,-230],[19.5,-170],[20.5,-135],[21.5,-105],[22.5,120],[23.5,145]] 


total_points_allowed = sum(team_points_allowed.values())
mean_points_allowed = total_points_allowed / len(team_points_allowed)
adjusted_matchup = 22.99/ mean_points_allowed
...
plt.title('Kuminga Season Distribution of Predicted Points')
